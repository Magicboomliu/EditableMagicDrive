...
# )
# from magicdrive.misc.test_utils_custom import (
#     prepare_all, run_one_batch
# )

from magicdrive.misc.test_utils_custom_train import(
    prepare_all, run_one_batch
)
...
@hydra.main(version_base=None, config_path="../configs",
            config_name="test_config_lidar_debug")
...
def main(cfg: DictConfig):
    ...
    #     print(sample['kwargs']['bboxes_3d_data']['bboxes'].shape)
    #     print(sample['kwargs']['lidars_3d_data']['lidars'].shape)
