...
class BEVControlNetModelWithLiDAR(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        super().__init__()
        logging.debug(
            "[BEVControlNetModelWithLiDAR] instantiating your own version of controlnet."
        )
        ...
        logging.debug(
            f"[BEVControlNetModelWithLiDAR] map_embedder: {self.controlnet_cond_embedding}")
